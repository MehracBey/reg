...
exports.run = async(client, message, args) => {
   if(!message.member.roles.cache.has('809014324312014849'))  //Kayıt yetkilisi rolü  ID 
...
//Burayı Doldur
   let devtr = message.guild.roles.cache.find(r => r.id === '809023226986364928') // Erkek rolü
   let kayıtsız = message.guild.roles.cache.find(r => r.id === '808423944255701032') //Kayıtsız 
//Burayı Doldur
   if(!devtr) {
   ...
   client.channels.cache.get('809040246636937216').send(embed)
}
