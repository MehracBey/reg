...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const kanal = '809144646219333673' //Kanal
  const rol = '809107977415163934' //Rol
  try { 
...
moment.locale("tr");
let kanal = client.channels.cache.get(`809018233415008266`) //Kayıt Kanalı ID
await kanal.send(`>>>  ${member} Sunucumuza Hoş Geldin! \n\n Seninle Birlikte ${member.guild.memberCount} Kişiyiz\n\n Birazdan <@&809014324312014849> Rolündeki Yetkililer Sizi Kayıt Edecek Lütfen Bekleyin\n\n Hesabın Oluşturulma Tarihi: ${moment(member.user.createdAt).format("DD MMMM YYYY, dddd (hh:mm)")}\n\n **__${member.guild.name}__** `, new Discord.MessageAttachment("https://cdn.discordapp.com/attachments/809101354235985940/811207961559957564/standard_2.gif"," kayit.gif")).catch(e => console.log(e))
}); 
...
let üyerol = '808423944255701032'//Kullanıcı otorol
  if (member.user.bot) {
